...
The most common signature for HOCs uses a functional programming pattern called "currying" to maximize function composition. This signature is used extensively in React libraries, such as [React Redux](https://react-redux.js.org/api/connect), a popular library for managing state in React applications.
