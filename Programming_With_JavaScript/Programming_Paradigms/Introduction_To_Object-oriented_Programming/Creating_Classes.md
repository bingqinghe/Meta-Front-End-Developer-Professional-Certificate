...
Next, inside the constructor function's body, you assign the passed-in color parameter's value to this.color, and the passed-in lightsOn parameter's value to this.lightsOn.
